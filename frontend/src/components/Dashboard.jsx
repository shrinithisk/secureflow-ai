        ...
        <div className="space-y-6 xl:col-span-1 no-print">
          ...
          <div className="bg-gradient-to-b from-slate-900/60 to-[#0f172a] border border-slate-800/80 rounded-2xl p-5 shadow-xl relative overflow-hidden shadow-indigo-950/5">
            ...
            <p className="text-[10px] text-slate-400 mb-4 leading-relaxed">
              Provide a Personal Access Token (PAT) to commit patches. Fine-grained tokens require: click <strong className="text-slate-200">Edit</strong> ➔ <strong className="text-slate-200">Repository permissions</strong> ➔ enable <code className="px-1.5 py-0.5 bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 text-[9px] rounded font-mono font-bold">Contents (Read/Write)</code> and <code className="px-1.5 py-0.5 bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 text-[9px] rounded font-mono font-bold">Workflows (Read/Write)</code>.
            </p>
            ...
            <div className="space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full text-xs text-slate-300 bg-slate-950/60 border border-slate-800 focus:border-indigo-500 rounded-xl pl-10 pr-4 py-2.5 focus:outline-none placeholder-slate-600"
                  value={githubToken}
                  onChange={(e) => {
              ...
              {githubToken && (
                <button
                  ...
                  className="w-full text-[10px] font-bold text-red-400 hover:text-red-300 bg-red-950/20 hover:bg-red-950/30 border border-red-900/35 hover:border-red-900/50 py-2 rounded-xl transition-all focus:outline-none cursor-pointer flex items-center justify-center gap-1 active:scale-98"
                >
            ...
            <div className="space-y-6">
              ...
              {activeTab === 'audit' && (
                <div className="bg-[#0f172a] border border-slate-800 rounded-2xl p-6 shadow-xl">
                  ...
                  <div className="bg-gradient-to-r from-indigo-950/20 via-slate-900/30 to-purple-950/25 border border-indigo-500/20 rounded-2xl p-5 mb-6 text-xs text-indigo-200 shadow-lg shadow-indigo-950/5 relative overflow-hidden backdrop-blur-md">
                    {/* Glowing highlight orb */}
                    <div className="absolute top-0 right-0 w-24 h-24 bg-indigo-500/5 rounded-full blur-xl pointer-events-none" />
                    
                    <h4 className="font-bold text-indigo-400 mb-3 flex items-center gap-1.5 uppercase tracking-widest text-[10px]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="bg-slate-950/40 border border-slate-850 p-3.5 rounded-xl flex flex-col gap-2">
                        <div className="flex items-center gap-2">
                          <span className="px-2 py-0.5 bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-[10px] font-bold rounded-md font-mono">
                            STEP 1
                          </span>
                          <h5 className="font-bold text-slate-200 text-xs">Codebase Auto-Fixes</h5>
                        </div>
                        <p className="text-[11px] text-slate-400 leading-relaxed">
                          Click <strong className="text-slate-200">"Apply Auto-Fix"</strong> on the vulnerability cards below to patch security issues in your code files first.
                        </p>
                      </div>
                      ...
                      <div className="bg-slate-950/40 border border-slate-850 p-3.5 rounded-xl flex flex-col gap-2">
                        <div className="flex items-center gap-2">
                          <span className="px-2 py-0.5 bg-purple-500/10 border border-purple-500/20 text-purple-400 text-[10px] font-bold rounded-md font-mono">
                            STEP 2
                          </span>
                          <h5 className="font-bold text-slate-200 text-xs">Workflow Auto-Deploy</h5>
                        </div>
                        <p className="text-[11px] text-slate-400 leading-relaxed">
                          Go to the <strong className="text-slate-200">Workflow Optimizer</strong> tab and click <strong className="text-slate-200">"Auto-Deploy to GitHub"</strong> to add the secure build pipeline.
                        </p>
                      </div>
                      ...
                      <div className="bg-slate-950/40 border border-slate-850 p-3.5 rounded-xl flex flex-col gap-2">
                        <div className="flex items-center gap-2">
                          <span className="px-2 py-0.5 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] font-bold rounded-md font-mono">
                            STEP 3
                          </span>
                          <h5 className="font-bold text-slate-200 text-xs">Clean up Old Workflows</h5>
                        </div>
                        <p className="text-[11px] text-slate-400 leading-relaxed">
                          Go to your repository on GitHub and delete old or broken YAML files inside <code className="px-1 py-0.5 bg-slate-950 border border-slate-850 rounded font-mono text-[10px] text-purple-300">.github/workflows/</code> to prevent failed checks.
                        </p>
                      </div>
                    </div>
                  </div>
